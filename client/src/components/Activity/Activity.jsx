...
export default function Activity() {
    ...
    // setErrors(validate({ ...activityPost,[e.target.name]: e.target.value}, countryId))
    ...
    return (
        ...
        <section className={Styles.name}>
            ...
            <div className={Styles.form1}>
                ...
                <input className={Styles.inputForm} type='number' value={activityPost.duration} name='duration'
                    onChange={e => handleChange(e)}>
    ...
    <button className={Styles.btnForm2} type='submit'>Crear Actividad</button>
...
//     if (Object.keys(errors).length === 0) {
//         //posteo la actividad desde el axios 
//         const res = axios.post('http://localhost:3001/activity', activityComplete);
//         alert("Actividad creada!")
...
//                     {errors.countryId && (<p className={Styles.p}>{errors.countryId}</p>)}
//                 </div>

//                 <div className={Styles.form1}>
//                     <label >Nombre:</label>
//                     <input className={Styles.inputForm} type='text' value={activityPost.name} name='name'
//                         onChange={(e) => {handleChange(e) }}>
...
//                 <div className={Styles.form1}>
//                     <label >Dificultad:</label>
//                     <input className={Styles.inputForm} type='number' value={activityPost.dificulty} name='dificulty'
//                         onChange={e => handleChange(e)}>
//                     </input>
